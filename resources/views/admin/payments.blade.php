                ...
                <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                            ...
                            <h4 class="card-title">{{ number_format($warehousePaymentStats['totalRevenue'], 2) }}</h4>
                            <small>{{ number_format($warehousePaymentStats['todayRevenue'], 2) }} today</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-stats card-round">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                            <p class="card-category">Warehouse Payments</p>
                            <h4 class="card-title">{{ number_format($warehousePaymentStats['totalPayments']) }}</h4>
                            <small>{{ number_format($warehousePaymentStats['successPayments']) }} successful</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                            <p class="card-category">Pending</p>
                            <h4 class="card-title">{{ number_format($warehousePaymentStats['pendingPayments']) }}</h4>
                            <small>Awaiting confirmation</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                            <p class="card-category">Refunded/Failed</p>
                            <h4 class="card-title">{{ number_format($warehousePaymentStats['refundedPayments'] + $warehousePaymentStats['failedPayments']) }}</h4>
                            <small>{{ number_format($warehousePaymentStats['refundedPayments']) }} refunded</small>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Warehouse Payment Section</h4>
            </div>
            <div class="card-body">
                <div class="table-responsive admin-table-scroll">
                    <table id="warehouse-payments-table" class="display table table-striped table-hover">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Invoice</th>
...
<script>
    $(document).ready(function () {
        $('#warehouse-payments-table').DataTable({
            processing: true,
            serverSide: false,
            ajax: {
                url: "{{ route('adminget.warehouse_payments') }}",
                dataSrc: function (json) {
                    if (json.status) {
                        return json.data;
                    }
            ...
            columns: [
                ...
                },
                {
                    data: 'warehouse_lead',
                    render: function(lead) {
                        if (!lead || !lead.warehouse) {
                            return '-';
                        }

                        return `${lead.warehouse.name} (${lead.warehouse.city})`;
                    }
                },
                {
                    data: 'method',
