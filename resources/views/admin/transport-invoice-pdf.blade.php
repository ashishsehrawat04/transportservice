    ...
    <div class="body-pad">
        <div class="grid-2">
            <table>
                <tr>
                    ...
                    <td>
                        <div class="label">Shipment Route</div>
                        <div class="value">{{ optional($lead->cityRoute)->from_city ?: '-' }} to {{ optional($lead->cityRoute)->to_city ?: '-' }}</div>
                        <div class="muted">Quantity: {{ $lead->quantity ?: 1 }}</div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="section">
            ...
            <table class="totals">
                ...
                @else
                    <tr>
                        <td class="t-label">Distance Charge</td>
                        <td class="t-value">{{ number_format((float) $lead->distance_charge, 2) }}</td>
                    </tr>
                @endif
                <tr>
