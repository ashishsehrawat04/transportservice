...
<section class="leads-section">
    <div class="container">
        <div class="leads-head">
            <div>
                <span class="leads-eyebrow">Packers &amp; Movers</span>
                <h2>Move Requests</h2>
            </div>
            <a href="{{ route('packers_movers.track') }}" class="primary-btn1 btn-hover">
                Track Move
                <span></span>
            </a>
        </div>
                            ...
                            <div class="lead-card-body">
                                ...
                                @if($isRejected)
                                    <div class="lead-note danger">
                                        ...
                                        This move request has been {{ strtolower($lead->admin_status) }}.
                                    </div>
                                @else
                                ...
                                <a href="{{ route('packers_movers.track', ['tracking_number' => $lead->tracking_number]) }}" class="lead-track-link">
