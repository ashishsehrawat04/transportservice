...
<section class="leads-section">
    <div class="container">
        <div class="leads-head">
            <div>
                <span class="leads-eyebrow">Warehouse</span>
                <h2>Storage Requests</h2>
            </div>
            <a href="{{ route('warehouse.track') }}" class="primary-btn1 btn-hover">
                Track Storage
                <span></span>
            </a>
        </div>
                        ...
                        <div class="lead-card">
                            ...
                            <div class="lead-card-body">
                                <div class="lead-meta-grid">
                                    <div class="lead-meta">
                                        <span>Warehouse</span>
                                        <strong>{{ optional($lead->warehouse)->name ?? '-' }} ({{ optional($lead->warehouse)->city ?? '-' }})</strong>
                                    </div>
                                    <div class="lead-meta">
                                        <span>Pickup</span>
                                ...
                                @if($isRejected)
                                    <div class="lead-note danger">
                                        ...
                                        This storage request has been {{ strtolower($lead->admin_status) }}.
                                    </div>
                                @else
                                ...
                                <a href="{{ route('warehouse.track', ['tracking_number' => $lead->tracking_number]) }}" class="lead-track-link">
