...
return new class extends Migration
{
    ...
    {
        Schema::create('packers_mover_leads', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('packers_mover_id')->constrained('packers_movers')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('packers_mover_leads');
    }
};
