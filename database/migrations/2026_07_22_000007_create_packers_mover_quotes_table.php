...
return new class extends Migration
{
    ...
    {
        Schema::create('packers_mover_quotes', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained('users')->onDelete('cascade');
            $table->foreignId('packers_mover_lead_id')->nullable()->constrained('packers_mover_leads')->onDelete('set null');
            ...
            $table->string('packers_mover_name')->nullable();
            $table->string('packers_mover_city')->nullable();
            $table->text('packers_mover_address')->nullable();
    ...
    {
        Schema::dropIfExists('packers_mover_quotes');
    }
};
